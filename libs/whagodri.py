...
def getMultipleFilesThread(bearer, entries_r, local, entries_m, threadName):
    ...
    if request.status_code == 200:
        ...
        now += 1
        print("    [+] Number: " + str(now) + "\n        [-] " + threadName + "=> Not Downloaded: '" + local + "'\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--flush", help="Delete log file to sync from the beginning", action="store_true")
